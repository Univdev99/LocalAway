            ...
            <div class="row">
                  ...
                  <div class="col-12">
                    <div class="my-form-row">
                      ...
                      <input id="phone-number" class="form-control" name="phone_number" type="tel">
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <textarea id="notes" name="notes" class="form-control" style="width: 100%; height: 8em;"></textarea>
                  </div>
