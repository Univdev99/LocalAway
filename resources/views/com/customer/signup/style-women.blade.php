...
<div class="container signup-container">
    ...
    <form id="style" method="POST" action="{{route('customer.signup.style.save')}}" enctype="multipart/form-data">
        ...
        <div class="row item first-row multiselect-row" id="row-women-style">
            <div class="m-auto text-center">
                ...
                <div class="row mx-0">
                    <div class="d-block flex-wrap m-lg-4 mx-auto text-center">
                        ...
                        <input type="checkbox" id="style1" name="style[]" value="Edgy" @if($customer->style == "Edgy" || !$customer->style) checked @endif >
                    ...
                    <div class="d-block flex-wrap m-lg-4 mx-auto text-center">
                        ...
                        <input type="checkbox" id="style2" name="style[]" value="Casual" @if($customer->style == "Casual") checked @endif >
                    ...
                    <div class="d-block flex-wrap m-lg-4 mx-auto text-center">
                        ...
                        <input type="checkbox" id="style3" name="style[]" value="Classic" @if($customer->style == "Classic") checked @endif >
                    ...
                    <div class="d-block flex-wrap m-lg-4 mx-auto text-center">
                        ...
                        <input type="checkbox" id="style4" name="style[]" value="Retro" @if($customer->style == "Retro") checked @endif >
        ...
        <div class="row item multiselect-row" id="row-women-color">
            <div class="m-auto">
        ...
        <div class="row item multiselect-row" id="row-women-material">
            <div class="col-xl-6 col-lg-7 col-md-10 text-center mx-auto">
                <div class="my-form-row">
                    <p class="mt-3">Any materials you don't like?</p>

                    <div class="row justify-content-center">
                        <input type="checkbox" id="style-casual1" name="dislike_material[]" value="Faux Leather" @if(strpos($customer->dislike_material, "Faux Leather") != false) checked @endif>
                        <label for="style-casual1" class="select-btn">Faux Leather</label>

                        <input type="checkbox" id="style-casual2" name="dislike_material[]" value="Polyester" @if(strpos($customer->dislike_material, "Polyester") != false) checked @endif>
                        <label for="style-casual2" class="select-btn">Polyester</label>

                        <input type="checkbox" id="style-casual3" name="dislike_material[]" value="Faux Fur" @if(strpos($customer->dislike_material, "Faux Fur") != false) checked @endif>
                        <label for="style-casual3" class="select-btn">Faux Fur</label>

                        <input type="checkbox" id="style-casual4" name="dislike_material[]" value="Gold" @if(strpos($customer->dislike_material, "Gold") != false) checked @endif>
                        <label for="style-casual4" class="select-btn">Gold</label>

                        <input type="checkbox" id="style-casual5" name="dislike_material[]" value="Nickel" @if(strpos($customer->dislike_material, "Nickel") != false) checked @endif>
                        <label for="style-casual5" class="select-btn">Nickel</label>

                        <input type="checkbox" id="style-casual6" name="dislike_material[]" value="Silver" @if(strpos($customer->dislike_material, "Silver") != false) checked @endif>
        ...
        <div class="row item multiselect-row" id="row-women-pattern">
                ...
                <div class="my-form-row text-center">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="checkbox" id="style-pattern1" name="dislike_pattern[]" value="Geometric"@if(strpos($customer->dislike_pattern, "Geometric") != false) checked @endif>
                        ...
                        <div class="col">
                            ...
                            <input type="checkbox" id="style-pattern2" name="dislike_pattern[]" value="Animal Prints" @if(strpos($customer->dislike_pattern, "Animal Prints" ) != false) checked @endif>
                        ...
                        <div class="col">
                            ...
                            <input type="checkbox" id="style-pattern3" name="dislike_pattern[]" value="Houndstooth" @if(strpos($customer->dislike_pattern, "Houndstooth" ) != false) checked @endif>
                        ...
                        <div class="col">
                            ...
                            <input type="checkbox" id="style-pattern4" name="dislike_pattern[]" value="Camoflauge" @if(strpos($customer->dislike_pattern, "Camoflauge" ) != false) checked @endif>
                        ...
                        <div class="col">
                            ...
                            <input type="checkbox" id="style-pattern5" name="dislike_pattern[]" value="Florals" @if(strpos($customer->dislike_pattern, "Florals" ) != false) checked @endif>
                        ...
                        <div class="col">
                            ...
                            <input type="checkbox" id="style-pattern6" name="dislike_pattern[]" value="Plaid" @if(strpos($customer->dislike_pattern, "Plaid" ) != false) checked @endif>
        ...
        <div class="row item item-submit end-part" id="row-women-almost-done">
            ...
            <div class="col-8 offset-2 mt-3">
              <div class="my-form-row">
                ...
                <br/>
                <textarea class="additional-note" id="notes" name="notes" value="{{ $customer->notes }}"></textarea>
