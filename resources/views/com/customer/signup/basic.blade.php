...
@csrf
            ...
            <div class="my-form-row text-center">
                ...
                <div class="d-flex flex-wrap justify-content-center">
                    ...
                    <div class="ml-sm-5 mx-auto img-selector">
                        ...
                        <input type="radio" id="gender-2" class="img-radio" name="gender" value="female" @if($customer->gender != 'male') checked @endif/>
    ...
    <div class="row item" id="row-height">
        <div class="col text-center mx-auto" style="flex: 0 0 400px;max-width: 400px;">
            <div class="my-form-row">
                ...
                <label class="label_unit"><input type="radio" class="mx-2 radio-unit" name="height_unit" value="imperial" @if($customer->height_unit != 'metric' || !$customer->height_unit) checked @endif>Imperial</label>
                <label class="label_unit"><input type="radio" class="mx-2 radio-unit" name="height_unit" value="metric" @if($customer->height_unit == 'metric') checked @endif>Metric</label>
                {{-- <div class="row justify-content-center">
                    <div class="col-6 text-left">
                        <label for="height">*Height</label>                        
                        <input id="height" name="height_size" class="form-control text-answer" type="number" min="0" value="{{ $customer->height_size }}" required/>
                    </div>
                    <div class="col-6" style="align-self: flex-end;">
                        <select name="height_unit" class="afit-select" required>
                            <option value="Feet"  @if($customer->height_unit == 'Feet' || !$customer->height_unit) selected @elseif($customer->height_unit == "Centimeter") hidden @endif>Feet</option>
                            <option value="Inches"  @if($customer->height_unit == 'Inches') selected @elseif($customer->height_unit == "Centimeter") hidden @endif>Inches</option>
                            <option value="Centimeter"  @if($customer->height_unit == 'Centimeter') selected @else hidden @endif>Centimeter</option>
                        </select>
                    </div>
                </div> --}}
                <div class="d-flex mb-4 mt-5">
                    <div class="height_div1 text-left mx-auto" style="width:100px;">
                        <label class="height_comment" for="height1">@if($customer->height_unit != 'metric' || !$customer->height_unit) *Feet @else *Centimeter @endif</label>
                        <input id="height1" name="height_size" class="form-control text-answer" type="number" min="0" value="{{ $customer->height_size }}" required/>
                    </div>
    ...
    <div class="row item" id="row-age">
        <div class="col-xl-6 col-lg-7 col-md-10 text-center mx-auto">
            <div class="my-form-row">
                ...
                <div class="row justify-content-center">
                    <input type="radio" id="age-1" name="age_range" value="18-25" checked @if($customer->age_range == "18-25" || !$customer->age_range) checked @endif>
                    <label for="age-1" class="select-btn">18-25</label>

                    <input type="radio" id="age-2" name="age_range" value="26-30" @if($customer->age_range == "26-30") checked @endif>
                    <label for="age-2" class="select-btn">26-30</label>

                    <input type="radio" id="age-3" name="age_range" value="31-35"  @if($customer->age_range == "31-35") checked @endif>
                    <label for="age-3" class="select-btn">31-35</label>

                    <input type="radio" id="age-4" name="age_range" value="36-40"  @if($customer->age_range == "36-40") checked @endif>
                    <label for="age-4" class="select-btn">36-40</label>

                    <input type="radio" id="age-5" name="age_range" value="41-50"  @if($customer->age_range == "41-50") checked @endif>
                    <label for="age-5" class="select-btn">41-50</label>

                    <input type="radio" id="age-6" name="age_range" value="51-60"  @if($customer->age_range == "51-60") checked @endif>
                    <label for="age-6" class="select-btn">51-60</label>

                    <input type="radio" id="age-7" name="age_range" value="61-70"  @if($customer->age_range == "61-70") checked @endif>
                    <label for="age-7" class="select-btn">61-70</label>

                    <input type="radio" id="age-8" name="age_range" value="71-80"  @if($customer->age_range == "71-80") checked @endif>
    ...
    <div class="item" id="row-capsule-date">
        <div class="my-form-row text-center mx-auto">
            ...
            <input id="trip-date" class="form-control text-center mx-auto text-answer" name="capsule_date" type="text" placeholder="Please set date." value="@if(!$customer->capsule_date) {{ $customer->capsule_date }} @else {{ date_format($customer->capsule_date,'m/d/Y') }} @endif" required/>
        </div>
    </div>
    ...
    <div class="row item" id="row-events">
        <div class="col-xl-6 col-lg-7 col-md-10 text-center mx-auto">
            <div class="my-form-row">
                ...
                <div class="row justify-content-center">
                    <input type="radio" id="event-1" name="events" value="Professional" @if($customer->events == "Professional" || !$customer->events) checked @endif>
                    <label for="event-1" class="select-btn">Lounging at home</label>

                    <input type="radio" id="event-2" name="events" value="Happy Hour" @if($customer->events == "Happy Hour") checked @endif>
                    <label for="event-2" class="select-btn">Zoom meeting</label>

                    <input type="radio" id="event-3" name="events" value="Wedding Guest" @if($customer->events == "Wedding Guest") checked @endif>
                    <label for="event-3" class="select-btn">Exercising</label>

                    <input type="radio" id="event-4" name="events" value="Sightseeing" @if($customer->events == "Sightseeing") checked @endif>
                    <label for="event-4" class="select-btn">Dress up</label>

                    <input type="radio" id="event-5" name="events" value="Sunday Brunch" @if($customer->events == "Sunday Brunch") checked @endif>
                    <label for="event-5" class="select-btn">Cozy</label>

                    <input type="radio" id="event-6" name="events" value="Surprise Me" @if($customer->events == "Surprise Me") checked @endif>
                    <label for="event-6" class="select-btn">Surprise Me</label>

                    <input type="radio" id="event-7" name="events" value="Upcoming Trip" @if($customer->events == "Upcoming Trip") checked @endif>
    ...
    <div class="row item item-submit end-part" id="row-shipping-address">
        ...
        <div class="col-6 offset-3">
            <div class="my-form-row">
            <label for="basic-street-address">*Street Address</label>
            <input id="basic-street-address" type="text" name="street_address" class="form-control"  value="{{ $customer->street_address }}">
            </div>
        </div>
        ...
        <div class="col-6 offset-3">
            <div class="my-form-row">
            <label for="basic-city">*City</label>
            <input id="basic-city" type="text" name="city" class="form-control"  value="{{ $customer->city }}">
            </div>
        </div>
        ...
        <div class="col-3 offset-3">
            <div class="my-form-row">
            <label for="basic-state">*State</label>
            <input id="basic-state" type="text" name="state" class="form-control"   value="{{ $customer->state }}">
            </div>
        </div>
        ...
        <div class="col-3">
            <div class="my-form-row">
            <label for="basic-zip-code">*Zip Code</label>
            <input id="basic-zip-code" type="text" name="zip_code" class="form-control" value="{{ $customer->zip_code }}">
            </div>
        </div>
    </div>
