...
<div class="container signup-container">
    ...
    <form id="sizing" method="POST" action="{{route('customer.signup.sizing.save')}}" enctype="multipart/form-data">
            ...
            <div class="m-auto text-center">
                ...
                <div class="row">
                    ...
                    <div class="d-block flex-wrap m-4 p-4 text-center img-selector">
                        ...
                        <input type="radio" class="img-radio" name="body_type" value="inverted_triangle" @if($body_type == "inverted_triangle") checked @endif>
                    ...
                    <div class="d-block flex-wrap m-4 p-4 text-center img-selector">
                        ...
                        <input type="radio" class="img-radio" name="body_type" value="pear" @if($body_type == "pear") checked @endif>
                        <label>Pear</label>
                    </div>
                    ...
                    <div class="d-block flex-wrap m-4 p-4 text-center img-selector">
                        ...
                        <input type="radio" class="img-radio" name="body_type" value="rectangle" @if($body_type == "rectangle") checked @endif>
            ...
            <div class="col-xl-6 col-lg-7 col-md-10 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row justify-content-center my-3">
                        <input type="radio" id="women-casual1" name="casual_shirt_size" value="S" @if($casual_shirt_size == "S" || !$casual_shirt_size) checked @endif>
                        <label for="women-casual1" class="select-btn">S</label>

                        <input type="radio" id="women-casual2" name="casual_shirt_size" value="M" @if($casual_shirt_size == "M") checked @endif>
                        <label for="women-casual2" class="select-btn">M</label>

                        <input type="radio" id="women-casual3" name="casual_shirt_size" value="L" @if($casual_shirt_size == "L") checked @endif>
                        <label for="women-casual3" class="select-btn">L</label>

                        <input type="radio" id="women-casual4" name="casual_shirt_size" value="XL" @if($casual_shirt_size == "XL") checked @endif>
                        <label for="women-casual4" class="select-btn">XL</label>

                        <input type="radio" id="women-casual5" name="casual_shirt_size" value="XXL" @if($casual_shirt_size == "XXL") checked @endif>
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row justify-content-center my-3">
                        @for ($i = 0; $i <= 18; $i+=2)
                            @if ($i == 0)
                                <input type="radio" id={{ "women-blouse" . $i }} name="buttonup_blouse_size" value={{ $i }} @if(intval($buttonup_blouse_size) == $i || !$buttonup_blouse_size) checked @endif>
                            @else
                                <input type="radio" id={{ "women-blouse" . $i }} name="buttonup_blouse_size" value={{ $i }} @if(intval($buttonup_blouse_size) == $i) checked @endif>
                            @endif
                    ...
                    <select name="buttonup_blouse_fit" class="afit-select" required>
                        <option value="none" placeholder="How do you like the fit?" disabled>How do you like the fit?</option>
                        <option value="smaller" @if($buttonup_blouse_fit == "smaller" || !$buttonup_blouse_fit) selected @endif>Smaller</option>
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row ml-3">
                        ...
                        @for ($i = 28; $i <= 38; $i+=2)
                            @if ($i == 28)
                                <input type="radio" id={{ "women-bra" . $i }} name="bra_size" value={{ $i }} @if(intval($bra_size) == $i || !$bra_size) checked @endif >
                            @else
                                <input type="radio" id={{ "women-bra" . $i }} name="bra_size" value={{ $i }} @if(intval($bra_size) == $i) checked @endif >
                            @endif
                    ...
                    <div class="row ml-3">
                        ...
                        <input type="radio" id="women-cup1" name="bra_cup" value="AA" @if($bra_cup == "AA" || !$bra_cup) checked @endif>
                        <label for="women-cup1" class="select-btn">AA</label>

                        <input type="radio" id="women-cup2" name="bra_cup" value="A"  @if($bra_cup == "A" ) checked @endif>
                        <label for="women-cup2" class="select-btn">A</label>

                        <input type="radio" id="women-cup3" name="bra_cup" value="B" @if($bra_cup == "B") checked @endif>
                        <label for="women-cup3" class="select-btn">B</label>

                        <input type="radio" id="women-cup4" name="bra_cup" value="C"  @if($bra_cup == "C" ) checked @endif>
                        <label for="women-cup4" class="select-btn">C</label>

                        <input type="radio" id="women-cup5" name="bra_cup" value="D"  @if($bra_cup == "D" ) checked @endif>
                        <label for="women-cup5" class="select-btn">D</label>

                        <input type="radio" id="women-cup6" name="bra_cup" value="DD"  @if($bra_cup == "DD" ) checked @endif>
                        <label for="women-cup6" class="select-btn">DD</label>

                        <input type="radio" id="women-cup7" name="bra_cup" value="DDD"  @if($bra_cup == "DDD" ) checked @endif>
                        <label for="women-cup7" class="select-btn">DDD</label>

                        <input type="radio" id="women-cup8" name="bra_cup" value="D"  @if($bra_cup == "D" ) checked @endif>
                        <label for="women-cup8" class="select-btn">G</label>

                        <input type="radio" id="women-cup9" name="bra_cup" value="+"  @if($bra_cup == "+" ) checked @endif>
            ...
            <div class="col-xl-8 col-lg-10 col-md-12 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row ml-3 pant-setting">
                        ...
                        <input type="radio" id="women-waist1" name="pant_waist_fit" value="High Rise" @if($pant_waist_fit == "High Rise" || !$pant_waist_fit) checked @endif>
                        <label for="women-waist1" class="select-btn">High Rise</label>

                        <input type="radio" id="women-waist2" name="pant_waist_fit" value="Natural" @if($pant_waist_fit == "Natural") checked @endif>
                        <label for="women-waist2" class="select-btn">Natural</label>

                        <input type="radio" id="women-waist3" name="pant_waist_fit" value="Medium Rise" @if($pant_waist_fit == "Medium Rise") checked @endif>
                        <label for="women-waist3" class="select-btn">Medium Rise</label>

                        <input type="radio" id="women-waist4" name="pant_waist_fit" value="Low Rise" @if($pant_waist_fit == "Low Rise") checked @endif>
                        <label for="women-waist4" class="select-btn">Low Rise</label>
                    </div>

                    <div class="row ml-3 pant-setting">
                        <h5 class="text-center my-auto color-brown"> Rise </h5>
                        <input type="radio" id="women-rise1" name="pant_rise" value="Straight" @if($pant_rise == "Straight" || !$pant_rise) checked @endif>
                        <label for="women-rise1" class="select-btn">Straight</label>

                        <input type="radio" id="women-rise2" name="pant_rise" value="Tapered" @if($pant_rise == "Tapered") checked @endif>
                        <label for="women-rise2" class="select-btn">Tapered</label>

                        <input type="radio" id="women-rise3" name="pant_rise" value="Bootcut" @if($pant_rise == "Bootcut") checked @endif>
                        <label for="women-rise3" class="select-btn">Bootcut</label>
                    </div>

                    <div class="row ml-3 pant-setting">
                        <h5 class="text-center my-auto color-brown"> Fit </h5>
                        <input type="radio" id="women-fit1" name="pant_fit" value="Relaxed" @if($pant_fit == "Relaxed" || !$pant_fit) checked @endif>
                        <label for="women-fit1" class="select-btn">Relaxed</label>

                        <input type="radio" id="women-fit2" name="pant_fit" value="CLassic" @if($pant_fit == "CLassic") checked @endif>
                        <label for="women-fit2" class="select-btn">Classic</label>

                        <input type="radio" id="women-fit3" name="pant_fit" value="Slim" @if($pant_fit == "Slim") checked @endif>
                        <label for="women-fit3" class="select-btn">Slim</label>

                        <input type="radio" id="women-fit4" name="pant_fit" value="Skinny" @if($pant_fit == "Skinny") checked @endif>
            ...
            <div class="col-xl-6 col-lg-7 col-md-10 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row justify-content-center">
                        @for ($i = 0; $i <= 18; $i+=2)
                            @if ($i == 0)
                                <input type="radio" id={{ "women-pant" . ($i) }} name="pant_size" value={{ $i }} @if(intval($pant_size) == $i || !$pant_size) checked @endif>
                            @else
                                <input type="radio" id={{ "women-pant" . ($i) }} name="pant_size" value={{ $i }} @if(intval($pant_size) == $i) checked @endif>
                            @endif
        ...
        <div class="row item" id="row-women-skirt-length">
            <div class="col-xl-6 col-lg-7 col-md-10 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row justify-content-center">
                        <input type="radio" id="women-short1" name="skirt_size" value="Mini" @if($skirt_size == "Mini" || !$skirt_size) checked @endif >
                        <label for="women-short1" class="select-btn">Mini</label>

                        <input type="radio" id="women-short2" name="skirt_size" value="Knee" @if($skirt_size == "Knee") checked @endif >
                        <label for="women-short2" class="select-btn">Knee</label>

                        <input type="radio" id="women-short3" name="skirt_size" value="Maxi" @if($skirt_size == "Maxi") checked @endif >
                        <label for="women-short3" class="select-btn">Maxi</label>

                        <input type="radio" id="women-short4" name="skirt_size" value="No skirts" @if($skirt_size == "No skirts") checked @endif >
        ...
        <div class="row item" id="row-women-dress-style">
            <div class="col-xl-8 col-lg-10 col-md-12 text-center mx-auto">
                <div class="my-form-row">
                    ...
                    <div class="row justify-content-center">
                        <input type="radio" id="women-dress1" name="dress_style" value="Shift"  @if($dress_style == "Shift" || !$dress_style) checked @endif>
                        <label for="women-dress1" class="select-btn">Shift</label>

                        <input type="radio" id="women-dress2" name="dress_style" value="Fit & Flare" @if($dress_style == "Fit & Flare") checked @endif>
                        <label for="women-dress2" class="select-btn">Fit & Flare</label>

                        <input type="radio" id="women-dress3" name="dress_style" value="Sheath"  @if($dress_style == "Sheath" ) checked @endif>
                        <label for="women-dress3" class="select-btn">Sheath</label>

                        <input type="radio" id="women-dress4" name="dress_style" value="A-line"  @if($dress_style == "A-line" ) checked @endif>
                        <label for="women-dress4" class="select-btn">A-line</label>

                        <input type="radio" id="women-dress5" name="dress_style" value="I don't know"  @if($dress_style == "I don't know" ) checked @endif>
                ...
                <div class="my-form-row">
                    ...
                    <div class="row justify-content-center">
                        @for ($i = 5.5; $i <= 11; $i+=0.5)
                            @if ($i == 5.5)
                                <input type="radio" id={{ "men-shoe" . (($i - 5.5) * 2) }} name="shoe_size" value={{ $i }} @if(intval($shoe_size) == $i || !$shoe_size) checked @endif>
                            @else
                                <input type="radio" id={{ "men-shoe" . (($i - 5.5) * 2) }} name="shoe_size" value={{ $i }} @if(intval($shoe_size) == $i) checked @endif>
                            @endif
