...
<div class="row">
  ...
  <div class="col-12 mt-3">
    <div class="my-form-row">
      ...
      <label class="radio-container mb-2">
        Rectangle
        <input type="radio" name="men_body_type" value="rectangle">
      ...
      <label class="radio-container mb-2">
        Inverted Triangle
        <input type="radio" name="men_body_type" value="inverted_triangle">
        <span class="checkmark">
          <i class="fas fa-check check-sign"></i>
        </span>
      </label>
      ...
      <label class="radio-container mb-2">
        Tropizodial
        <input type="radio" name="men_body_type" value="tropizodial">
        <span class="checkmark">
          <i class="fas fa-check check-sign"></i>
        </span>
      </label>
  ...
  <div class="col-12">
    <div class="my-form-row">
      ...
      <select name="men_casual_shirts_fit" class="form-control fit-select">
        <option value="" placeholder="How do you like to fit?" hidden>How do you like to fit?</option>
