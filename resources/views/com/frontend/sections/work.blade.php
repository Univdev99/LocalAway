<section class="section slider-section bg-grey">
        <div class="row">
            ...
            <div class="row mt-5">
              ...
              <div class="col-lg-4 col-md-12">
                <p class='font-weight-bold mt-2 text-black text-center' style="height:60px;">
                  ...
                  <div  class = "text-center">
                    <span class='font-avenir'>The more detail, the better! However if you prefer to chat with a stylist, we have that as an option too.
                    </span>
                  </div>
              </div>
              <div class="col-lg-4 col-md-12">
